...
public class Product {
    ...
    public Product(String code, String brand, String name, int price, Date manufacturingDate) {
        ...
        System.out.println("Produect 클래스의 매개 변수 있는 생성자 호출...");
    }
    ...
    public Product(){
        ...
        * java.lang.0bject클래스의 생성자를 호출하게 된다.
        * 이유는 모든 클래스는 0bjest 클래스의 후손이기 때문이다..!  */
        super();
        System.out.println("ProDuct클래스의 기본 생성자 호출함. ");
