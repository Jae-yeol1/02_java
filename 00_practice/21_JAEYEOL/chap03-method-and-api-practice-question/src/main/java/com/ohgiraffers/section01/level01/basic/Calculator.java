...
public class Calculator {
    ...
    int sum = num1 + num2;
    String resultMessage = "10과20의 합은" + sum + "입니다.";
//        System.out.println("10과20의 합은" + sum + "입니다.");
    ...
    public String multiTwoNumber(int num1,int num2){
        int multi = num1 * num2;
        System.out.println("10과20의 곱은" + multi + "입니다.");
        return "";
    }
    ...
    public int multiTwoNumber2(int num1 , int num2){
        int multi2 = num1 * num2;
        System.out.println("10과20의 곱은"+ multi2 + "입니다");
        return 0;
    }
